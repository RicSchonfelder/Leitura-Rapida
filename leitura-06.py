...
class LeituraRapidaApp:
    ...
    def create_widgets(self):
        ...
        self.calculate_button = tk.Button(
            ...
            bg="#007BFF", fg="white", font=("Helvetica", 14), relief="flat", padx=10, pady=5
        )
    ...
    def iniciar_leitura(self):
        ...
        legend = tk.Label(
            leitura_window,
            text="Atalhos: ESC - Sair | + - Aumentar Velocidade | - - Reduzir Velocidade | R - Reiniciar Parágrafo",
            bg="#faedc9",
            font=("Helvetica", 10),
        )
        legend.pack(side="bottom", pady=5)
        ...
        leitura_window.bind("<r>", lambda e: self.reiniciar_paragrafo(display_label))
    ...
    def reiniciar_paragrafo(self, display_label):
        self.palavra_atual = max(self.palavra_atual - (self.palavra_atual % 10), 0)
